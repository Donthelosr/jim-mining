...
Config = {
	...
	Timings = { -- Time it takes to do things
		["Cracking"] = math.random(30000, 60000),
		["Washing"] = math.random(30000, 60000),
		["Panning"] = math.random(30000, 60000),
		["Pickaxe"] = math.random(30000, 60000),
		["Mining"] = math.random(20000, 40000),
		["Laser"] = math.random(30000, 60000),
		["OreRespawn"] = math.random(85000, 115000),
		["Crafting"] = 20000,
	},

	Locations =  {
		['MineStore'] = {
			{ name = "Mine", coords = vector4(-594.96, 2091.3, 131.47, 67.65), sprite = 527, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },		-- The location where you enter the mine
		...
		["Washing"] = {
			...
			-- { name = "Stone Washing", coords = vector3(-432.59, 2936.84, 13.87), sprite = 467, col = 3, disp = 6, blipTrue = false }, -- Stream Blip
			...
			-- { name = "Stone Washing", coords = vector3(907.06, 4377.66, 30.28), sprite = 467, col = 3, disp = 6, blipTrue = false }, -- Alamo Sea
		...
		["Panning"] = {
			{ name = "Gold Panning", coords = vector3(-1656.67, 2074.85, 87.37), sprite = 467, col = 5, disp = 6, blipTrue = false }, -- Vineyard
			{ name = "Gold Panning", coords = vector3(-1672.06, 2070.89, 91.68), sprite = 467, col = 5, blipTrue = false },
			{ name = "Gold Panning", coords = vector3(-1273.16, 1898.19, 100.82), sprite = 467, col = 5, disp = 6, blipTrue = false }, -- Tongva
			{ name = "Gold Panning", coords = vector3(-1551.31, 1444.15, 116.44), sprite = 467, col = 5, disp = 6, blipTrue = false }, -- Tongva
			...
			{ name = "Gold Panning", coords = vector3(-850.78, 4433.95, 14.21), sprite = 467, col = 5, disp = 6, blipTrue = false }, -- Wilderness
		},
		...
		['JewelCut'] = { -- The Location of the jewel cutting bench. Couldn't decide so left in smeltery
			{ name = "Jewel Cutting", coords = vector4(-1252.78, -821.15, 17.05, 130.0), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
			{ name = "Jewel Cutting", coords = vector4(-1259.59, -827.35, 17.1, 310.0), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
		},
...
OrePositions = {
	...
	vector4(2971.35, 2766.4, 40.42, 317.72),
	vector4(2976.93, 2769.31, 40.13, 314.07),
	vector4(2980.59, 2776.24, 39.74, 251.94),
	vector4(2981.25, 2786.64, 40.44, 306.76),
	vector4(2976.15, 2797.22, 41.63, 328.68),
	vector4(2989.16, 2808.97, 44.9, 311.12),
	vector4(2998.41, 2795.87, 44.96, 291.27),
	vector4(3004.96, 2782.89, 44.59, 279.07),
	vector4(2935.33, 2749.63, 44.82, 59.38),
	vector4(2927.85, 2759.9, 45.02, 91.61),
	vector4(2911.57, 2778.61, 45.37, 90.66),
	vector4(2918.83, 2782.3, 43.56, 10.42),
	vector4(2914.58, 2804.19, 43.89, 63.29),
	vector4(2938.96, 2827.41, 46.59, 356.31)
...
------------------------------------------------------------
	...
	--[[
		...
		['ruby_ring'] = 1700,
		['sapphire_ring'] = 1200,
		['diamond_ring_silver'] = 2250,
		['emerald_ring_silver'] = 1250,
		['ruby_ring_silver'] = 1500,
		['sapphire_ring_silver'] = 950,

		['diamond_necklace'] = 4000,
		['emerald_necklace'] = 3250,
		['ruby_necklace'] = 3000,
		['sapphire_necklace'] = 2500,
		['diamond_necklace_silver'] = 3500,
		['emerald_necklace_silver'] = 3000,
		['ruby_necklace_silver'] = 2750,
		['sapphire_necklace_silver'] = 2250,

		['diamond_earring'] = 2500,
		['emerald_earring'] = 2000,
		['ruby_earring'] = 2200,
		['sapphire_earring'] = 1500,
		['diamond_earring_silver'] = 2200,
		['emerald_earring_silver'] = 1750,
		['ruby_earring_silver'] = 1800,
		['sapphire_earring_silver'] = 1300,
...
--Mining Store Items
	Items = {
		label = "Mining Store",  slots = 3,
		items = {
			-- { name = "water_bottle", price = 2, amount = 100, info = {}, type = "item", slot = 1, },
			-- { name = "sandwich", price = 5, amount = 250, info = {}, type = "item", slot = 2, },
			...
			{ name = "pickaxe",	price = 250, amount = 100, info = {}, type = "item", slot = 2, },
			{ name = "miningdrill",	price = 1500, amount = 50, info = {}, type = "item", slot = 3, },
...
Crafting = {
	...
	--silverchain
	NeckCut = {
		{ ["silverchain"] = { ["silveringot"] = 10, }, },
		{ ["10kgoldchain"] = { ["goldingot"] = 10}, },
		{ ["chain_v2"] = { ["silverchain"] = 1,["lowdiamonds"] = 3 },  }, 
		{ ["chain_bdb"] = { ["10kgoldchain"] = 1,["emerald"] = 1 },  },
		{ ["chain_cp1"] = { ["silverchain"] = 1, ["highdiamonds"] = 3 }, },
		{ ["chain_cp2"] = { ["silverchain"] = 1, ["highdiamonds"] = 3 }, },
		{ ["chain_skull"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_skull2"] = { ["10kgoldchain"] = 1}, },

		{ ["chain_skull3"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_skull4"] = { ["10kgoldchain"] = 1}, },
		{ ["chain_skull5"] = { ["silverchain"] = 1, ["diamonds"] = 4 }, },
		{ ["chain_skull6"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },


		{ ["chain_skull7"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_nocap"] = { ["silverchain"] = 1, ["lowdiamonds"] = 3 }, },
		{ ["chain_snake"] = { ["silverchain"] = 1, ["diamonds"] = 4 }, },
		{ ["chain_link"] = { ["10kgoldchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_au1"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_au2"] = { ["silverchain"] = 1, ["diamonds"] = 4 }, },
		{ ["chain_au3"] = { ["10kgoldchain"] = 1, ["diamonds"] = 3 }, },
		{ ["chain_au4"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_au5"] = { ["silverchain"] = 1, ["diamonds"] = 3 }, },
		{ ["chain_au6"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_au7"] = { ["10kgoldchain"] = 1}, },
		{ ["chain_au8"] = { ["silverchain"] = 1, ["diamonds"] = 4 }, },
		{ ["chain_au9"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_au10"]  = { ["10kgoldchain"] = 1}, },
		{ ["chain_au11"]  = { ["10kgoldchain"] = 1}, },
		{ ["chain_au12"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_au13"] = { ["silverchain"] = 1, ["diamonds"] = 3 }, },
		{ ["chain_au14"] = { ["silverchain"] = 1, ["diamonds"] = 3 }, },
		{ ["chain_au15"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_au16"] = { ["silverchain"] = 1, ["diamonds"] = 5 }, },

		{ ["chain_1"] = { ["silverchain"] = 1, ["lowdiamonds"] = 6 }, },
		{ ["chain_2"] = { ["silverchain"] = 1, ["lowdiamonds"] = 5 }, },
		{ ["chain_3"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4 }, },
		{ ["chain_4"] = { ["silverchain"] = 1, ["lowdiamonds"] = 3 }, },
		{ ["chain_5"] = { ["silverchain"] = 1, ["lowdiamonds"] = 6 }, },
		{ ["chain_6"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_7"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4 }, },
		{ ["chain_8"] = { ["silverchain"] = 1, ["lowdiamonds"] = 5 }, },
		{ ["chain_9"] = { ["silverchain"] = 1, ["lowdiamonds"] = 6 }, },
		{ ["chain_10"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_11"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4 }, },
		{ ["chain_12"] = { ["silverchain"] = 1, ["lowdiamonds"] = 3 }, },


		{ ["chain_13"] = { ["silverchain"] = 1, ["lowdiamonds"] = 6 }, },
		{ ["chain_14"] = { ["silverchain"] = 1, ["highdiamonds"] = 4 }, },
		{ ["chain_15"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_16"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_17"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_18"] = { ["silverchain"] = 1, ["diamonds"] = 2 }, },
		{ ["chain_19"] = { ["silverchain"] = 1, ["lowdiamonds"] = 3 }, },
		{ ["chain_20"] = { ["silverchain"] = 1, ["diamonds"] = 4 }, },
		{ ["chain_21"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_22"] = { ["silverchain"] = 1, ["highdiamonds"] = 3 }, },
		{ ["chain_23"] = { ["silverchain"] = 1, ["highdiamonds"] = 2 }, },
		{ ["chain_24"] = { ["silverchain"] = 1, ["diamonds"] = 3 }, },
		{ ["chain_25"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_26"] = { ["silverchain"] = 1, ["diamonds"] = 2 }, },
		{ ["chain_27"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		{ ["chain_28"] = { ["silverchain"] = 1, ["lowdiamonds"] = 4}, },
		
	},
	EarCut = {
		{ ["goldearring"] = { ["goldingot"] = 1 }, ['amount'] = 2  },
		{ ["silverearring"] = { ["silveringot"] = 1 }, ['amount'] = 2  },
